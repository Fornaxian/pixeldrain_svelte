...
import { copy_text } from "$lib/util/Util.svelte";
...
<div>
	...
	<div class="limit_width">
		{#if app_name === "jdownloader"}
			<h2>
				Connect
				<img src="/img/icons/jdownloader.png" alt="JDownloader logo" class="app_icon_small"/>
		...
		{:else if app_name === "sharex"}
			<h2>
				Connect
				<img src="/img/icons/sharex.png" alt="ShareX logo" class="app_icon_small"/>
			...
			<ul>
				<li>
					<button on:click={() => {app_name = "jdownloader"}}>
						<img src="/img/icons/jdownloader.png" alt="JDownloader logo" class="app_icon"/>
						Connect JDownloader
					</button>
				</li>
				<li>
					<button on:click={() => {app_name = "sharex"}}>
						<img src="/img/icons/sharex.png" alt="ShareX logo" class="app_icon"/>
						Connect ShareX
					</button>
				</li>
			</ul>
